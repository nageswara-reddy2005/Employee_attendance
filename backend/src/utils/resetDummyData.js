...
const resetDummyData = async () => {
  try {
    ...
    // Delete only employees (keep managers)
    const deletedEmployees = await User.deleteMany({ role: 'employee' });
    ...
    console.log('📝 Adding Fresh Dummy Employees and Attendance Data...\n');
    ...
    console.log('\n' + '━'.repeat(60));
    console.log('\n✅ SUCCESS! Fresh dummy data added to database!\n');

    console.log('🚀 Next Steps:');
    console.log('   1. Start backend: npm run dev');
    console.log('   2. Start frontend: npm start');
    console.log('   3. Login as manager@example.com / Pass1234');
    console.log('   4. View Manager Dashboard with fresh data!\n');
